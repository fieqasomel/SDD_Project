...
<head>
    ...
    <title>Public User Registration - SDD System</title>
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet">
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>
<body class="min-h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-800 py-8 px-4">
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden backdrop-blur-sm bg-opacity-95">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-purple-700 text-white px-8 py-8 text-center relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <h2 class="text-3xl font-bold mb-2">Public User Registration</h2>
                    <p class="text-lg opacity-90">Create your account to access SDD System</p>
                </div>
            </div>
            ...
            <div class="p-8">
                ...
                <form method="POST" action="{{ route('register.publicuser.submit') }}" class="space-y-8">
                    @csrf
                    ...
                    <div class="bg-gray-50 rounded-2xl p-6 border-l-4 border-blue-500">
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="ic" name="ic" value="{{ old('ic') }}" placeholder="e.g., 123456789012" required
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200">
                            </div>
                            <div>
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <textarea id="address" name="address" rows="3" required
                                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors duration-200 resize-none">{{ old('address') }}</textarea>
                            </div>
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="tel" id="phone" name="phone" value="{{ old('phone') }}" placeholder="e.g., 0123456789" required
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors duration-200">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 rounded-2xl p-6">
                        <div class="flex items-start">
                            <input type="checkbox" id="terms" required
                                   class="w-5 h-5 text-blue-600 border-gray-300 rounded focus:ring-blue-500 focus:ring-2 mt-1 mr-3">
                    ...
                    <div class="flex flex-col md:flex-row gap-4">
                        ...
                        <button type="submit" 
                                class="flex-1 inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-700 hover:from-blue-700 hover:to-purple-800 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
