        ...
        <nav class="mt-4 px-4 space-y-2">
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('inquiries.history') }}" 
                   class="flex items-center px-4 py-2 text-sm font-medium rounded-lg {{ request()->routeIs('inquiries.history') ? 'bg-green-100 text-green-700' : 'text-gray-700 hover:bg-gray-100' }}">
                    <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
